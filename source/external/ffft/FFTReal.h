...
private:
   ...
   // vutu: raised from 12 to 16 — the incremental oscillators drift to ~4e-5
   // relative error in float at N=16384, too close to the analyzer's -90 dB
   // floor. The larger LUT (~128 KB at N=65536) keeps error at ~1e-7.
   enum {	      TRIGO_BD_LIMIT	= 16  };
